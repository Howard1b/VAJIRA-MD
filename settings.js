...
global.owner = process.env.OWNER_NUMBER  || '263713943278' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uUFUlIKA#6biC8nEsEuQx-lyw2MmvpKNzw-4PbaQerFmhjbOjfCw' ,
